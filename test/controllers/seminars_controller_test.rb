...
class SeminarsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create seminar" do
    assert_difference('Seminar.count') do
      post seminars_url, params: { seminar: { end_time: @seminar.end_time, start_time: @seminar.start_time, title: @seminar.title, user_id: @seminar.user_id } }
    end
  ...
  test "should update seminar" do
    patch seminar_url(@seminar), params: { seminar: { end_time: @seminar.end_time, start_time: @seminar.start_time, title: @seminar.title, user_id: @seminar.user_id } }
